...
<div class="wrapper">
    <div class="iq-sidebar  sidebar-default  ">
        <div class="iq-sidebar-logo d-flex align-items-end justify-content-between">
            <a href="<?= (session()->get('role') == 'Admin') ? base_url('admin') : base_url('owner') ?>" class="header-logo">
                <img src="<?= base_url() ?>/asset/img/logo.png" class="img-fluid rounded-normal light-logo" alt="logo">
                <span>SIPFOR</span>
            </a>
        ...
        <div class="data-scrollbar" data-scroll="1">
            <nav class="iq-sidebar-menu">
                <ul id="iq-sidebar-toggle" class="side-menu">
                    <li class="<?= ($title == 'Admin') ? 'active' : '' ?> sidebar-layout">
                        <a href="<?= (session()->get('role') == 'Admin') ? base_url('admin') : base_url('owner') ?>" class="svg-icon">
                    ...
                    <?php } else { ?>
                        <li class="<?= ($title == 'Data Fasilitas') ? 'active' : '' ?> sidebar-layout">
                        ...
                        <ul class="navbar-nav ml-auto navbar-list align-items-center">
                                                    ...
                                                    <div class="list-item d-flex justify-content-start align-items-start">
                                                        <div class="avatar">
                                                            <div class="avatar-img avatar-success avatar-20">
                                                                <span><img class="avatar is-squared rounded-circle" src="<?= base_url() ?>/template/backend/html/assets/images/user/2.jpg" alt="2.jpg"></span>
                                                            </div>
                                                        </div>
                                                        <div class="list-style-detail ml-2 mr-2">
                            ...
                            <li class="nav-item nav-icon dropdown">
                                <a href="#" class="nav-item nav-icon dropdown-toggle pr-0 search-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img src="<?= base_url() ?>/template/backend/html/assets/images/user/1.jpg" class="img-fluid avatar-rounded" alt="user">
                                    <span class="mb-0 ml-2 user-name hijau"><?= session()->get('nama') ?></span>
                                </a>
